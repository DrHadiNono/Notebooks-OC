...
from .blocked_cv import BlockedKFold
    ...
    def split(self, X, y=None, groups=None):
        ...
        for test_index in self._iter_test_masks(X, y, groups):
            ...
            if self.gap > 0:
                ...
                gap_zone_lower = np.arange(
                    min_test_id - self.gap, min_test_id, 1)
                gap_zone_upper = np.arange(
                    max_test_id, max_test_id + self.gap, 1)
